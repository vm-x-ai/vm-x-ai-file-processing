...
import type {
  ...
  GetFileData,
  GetFileContentData,
  GetFileEvaluationsData,
  GetEvaluationsData,
  CreateEvaluationData,
  CreateEvaluationError,
  CreateEvaluationResponse,
  GetEvaluationsTreeData,
  GetFilesByEvaluationData,
  DeleteEvaluationData,
  DeleteEvaluationError,
  UpdateEvaluationData,
  UpdateEvaluationError,
  UpdateEvaluationResponse,
  GetEvaluationCategoriesData,
  CreateEvaluationCategoryData,
  CreateEvaluationCategoryError,
  CreateEvaluationCategoryResponse,
  DeleteEvaluationCategoryData,
  DeleteEvaluationCategoryError,
  UpdateEvaluationCategoryData,
  UpdateEvaluationCategoryError,
  UpdateEvaluationCategoryResponse,
  GetEvaluationsByCategoryData,
  SimilaritySearchData,
  SimilaritySearchError,
  SimilaritySearchResponse,
  GetEvaluationTemplatesData,
  CreateEvaluationTemplateData,
  CreateEvaluationTemplateError,
  CreateEvaluationTemplateResponse,
  DeleteEvaluationTemplateData,
  DeleteEvaluationTemplateError,
  UpdateEvaluationTemplateData,
  UpdateEvaluationTemplateError,
  UpdateEvaluationTemplateResponse,
  HealthHealthGetData,
} from '../types.gen';
...
export const uploadIntentQueryKey = (options: Options<UploadIntentData>) =>
  createQueryKey('uploadIntent', options);
 ...
 * Upload an intent for a project
 */
export const uploadIntentMutation = (
  options?: Partial<Options<UploadIntentData>>
): UseMutationOptions<
  UploadIntentResponse2,
  UploadIntentError,
  Options<UploadIntentData>
> => {
  const mutationOptions: UseMutationOptions<
    UploadIntentResponse2,
    UploadIntentError,
 ...
 * Search files for a project
 */
export const searchFilesMutation = (
  options?: Partial<Options<SearchFilesData>>
): UseMutationOptions<
  SearchFilesResponse,
  SearchFilesError,
  Options<SearchFilesData>
> => {
  const mutationOptions: UseMutationOptions<
    SearchFilesResponse,
    SearchFilesError,
...
export const getFileEvaluationsQueryKey = (
  options: Options<GetFileEvaluationsData>
) => createQueryKey('getFileEvaluations', options);

/**
 * Get File Evaluations
 * Get all evaluations for a file
 */
export const getFileEvaluationsOptions = (
  options: Options<GetFileEvaluationsData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const getEvaluationsQueryKey = (options: Options<GetEvaluationsData>) =>
  createQueryKey('getEvaluations', options);
...
export const createEvaluationQueryKey = (
  options: Options<CreateEvaluationData>
) => createQueryKey('createEvaluation', options);

/**
 * Create Evaluation
 * Create an evaluation for a project
 */
export const createEvaluationOptions = (
  options: Options<CreateEvaluationData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const getEvaluationsTreeQueryKey = (
  options: Options<GetEvaluationsTreeData>
) => createQueryKey('getEvaluationsTree', options);

/**
 * Get Evaluations Tree
 * Get all evaluations for a project
 */
export const getEvaluationsTreeOptions = (
  options: Options<GetEvaluationsTreeData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const getFilesByEvaluationQueryKey = (
  options: Options<GetFilesByEvaluationData>
) => createQueryKey('getFilesByEvaluation', options);

/**
 * Get Files By Evaluation
 * Get all files for an evaluation
 */
export const getFilesByEvaluationOptions = (
  options: Options<GetFilesByEvaluationData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const updateEvaluationMutation = (
  options?: Partial<Options<UpdateEvaluationData>>
): UseMutationOptions<
  UpdateEvaluationResponse,
  UpdateEvaluationError,
  Options<UpdateEvaluationData>
> => {
  const mutationOptions: UseMutationOptions<
    UpdateEvaluationResponse,
    UpdateEvaluationError,
...
export const getEvaluationCategoriesQueryKey = (
  options: Options<GetEvaluationCategoriesData>
) => createQueryKey('getEvaluationCategories', options);

/**
 * Get Evaluation Categories
 * Get all evaluation categories for a project
 */
export const getEvaluationCategoriesOptions = (
  options: Options<GetEvaluationCategoriesData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const createEvaluationCategoryQueryKey = (
  options: Options<CreateEvaluationCategoryData>
) => createQueryKey('createEvaluationCategory', options);

/**
 * Create Evaluation Category
 * Create an evaluation category for a project
 */
export const createEvaluationCategoryOptions = (
  options: Options<CreateEvaluationCategoryData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Create an evaluation category for a project
 */
export const createEvaluationCategoryMutation = (
  options?: Partial<Options<CreateEvaluationCategoryData>>
): UseMutationOptions<
  CreateEvaluationCategoryResponse,
  CreateEvaluationCategoryError,
  Options<CreateEvaluationCategoryData>
> => {
  const mutationOptions: UseMutationOptions<
    CreateEvaluationCategoryResponse,
    CreateEvaluationCategoryError,
 ...
 */
export const deleteEvaluationCategoryMutation = (
  options?: Partial<Options<DeleteEvaluationCategoryData>>
): UseMutationOptions<
  unknown,
  DeleteEvaluationCategoryError,
  Options<DeleteEvaluationCategoryData>
> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DeleteEvaluationCategoryError,
 ...
 */
export const updateEvaluationCategoryMutation = (
  options?: Partial<Options<UpdateEvaluationCategoryData>>
): UseMutationOptions<
  UpdateEvaluationCategoryResponse,
  UpdateEvaluationCategoryError,
  Options<UpdateEvaluationCategoryData>
> => {
  const mutationOptions: UseMutationOptions<
    UpdateEvaluationCategoryResponse,
    UpdateEvaluationCategoryError,
...
export const getEvaluationsByCategoryQueryKey = (
  options: Options<GetEvaluationsByCategoryData>
) => createQueryKey('getEvaluationsByCategory', options);

/**
 * Get Evaluations By Category
 * Get all evaluations for a specific category
 */
export const getEvaluationsByCategoryOptions = (
  options: Options<GetEvaluationsByCategoryData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const similaritySearchQueryKey = (
  options: Options<SimilaritySearchData>
) => createQueryKey('similaritySearch', options);

/**
 * Similarity Search
 * Perform a similarity search
 */
export const similaritySearchOptions = (
  options: Options<SimilaritySearchData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Perform a similarity search
 */
export const similaritySearchMutation = (
  options?: Partial<Options<SimilaritySearchData>>
): UseMutationOptions<
  SimilaritySearchResponse,
  SimilaritySearchError,
  Options<SimilaritySearchData>
> => {
  const mutationOptions: UseMutationOptions<
    SimilaritySearchResponse,
    SimilaritySearchError,
...
export const getEvaluationTemplatesQueryKey = (
  options: Options<GetEvaluationTemplatesData>
) => createQueryKey('getEvaluationTemplates', options);

/**
 * Get Evaluation Templates
 * Get all evaluation templates for a project
 */
export const getEvaluationTemplatesOptions = (
  options: Options<GetEvaluationTemplatesData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
...
export const createEvaluationTemplateQueryKey = (
  options: Options<CreateEvaluationTemplateData>
) => createQueryKey('createEvaluationTemplate', options);

/**
 * Create Evaluation Template
 * Create an evaluation template for a project
 */
export const createEvaluationTemplateOptions = (
  options: Options<CreateEvaluationTemplateData>
) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Create an evaluation template for a project
 */
export const createEvaluationTemplateMutation = (
  options?: Partial<Options<CreateEvaluationTemplateData>>
): UseMutationOptions<
  CreateEvaluationTemplateResponse,
  CreateEvaluationTemplateError,
  Options<CreateEvaluationTemplateData>
> => {
  const mutationOptions: UseMutationOptions<
    CreateEvaluationTemplateResponse,
    CreateEvaluationTemplateError,
 ...
 */
export const deleteEvaluationTemplateMutation = (
  options?: Partial<Options<DeleteEvaluationTemplateData>>
): UseMutationOptions<
  unknown,
  DeleteEvaluationTemplateError,
  Options<DeleteEvaluationTemplateData>
> => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DeleteEvaluationTemplateError,
 ...
 */
export const updateEvaluationTemplateMutation = (
  options?: Partial<Options<UpdateEvaluationTemplateData>>
): UseMutationOptions<
  UpdateEvaluationTemplateResponse,
  UpdateEvaluationTemplateError,
  Options<UpdateEvaluationTemplateData>
> => {
  const mutationOptions: UseMutationOptions<
    UpdateEvaluationTemplateResponse,
    UpdateEvaluationTemplateError,
