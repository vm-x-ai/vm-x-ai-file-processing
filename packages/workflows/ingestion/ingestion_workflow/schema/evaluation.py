...
class HttpEvaluationCreate(BaseModel):
    ...
    system_prompt: Optional[str] = Field(None, description="System prompt for the evaluation")
    ...
    evaluation_options: Optional[list[str]] = Field(None, description="Options for enum_choice evaluations")
    parent_evaluation_id: Optional[UUID] = Field(None, description="Parent evaluation ID")
    parent_evaluation_option: Optional[str] = Field(None, description="Parent evaluation option")
    ...
    category_name: Optional[str] = Field(None, description="Name of new category to create")
    category_description: Optional[str] = Field(None, description="Description for new category")
